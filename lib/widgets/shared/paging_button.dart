      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child : Text('${page + 1}',style: TextStyle(fontSize: 16, color: Color.fromRGBO(140, 156, 171,1), ), textAlign: TextAlign.center,),
            decoration: BoxDecoration(
              border: Border.all(width: 1.0, color: Color.fromRGBO(140, 156, 171,1),),
