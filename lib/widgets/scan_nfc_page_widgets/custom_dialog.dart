          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ValueProfile(
                  ...
                  label: data['livingPartner']),
              ValueProfile(
                  icon: FontAwesomeIcons.university,
                  label: data['department']['name']),
              ValueProfile(icon: FontAwesomeIcons.phone, label: data['phone']),
              ValueProfile(icon: FontAwesomeIcons.envelope, label: data['email']),
              SizedBox(
                height: displayHeight(context) * 2,
              ),
              Align(
